...
1. **Lambda Function**: Write a lambda function that multiplies two numbers.
          ...
          result= multi(5,4)
          print(f"The multiflication of two number is = {result}")

   
3. **Recursive Function**: Write a recursive function that calculates the sum of the first `n` numbers.

4. 
5. **Variable-Length Arguments**: Write a function that accepts any number of arguments and returns their average.
