...
1. **Basic Conditions**:
   - Write a program to check if someone is eligible for a bus pass. If they are below 5 years, the bus pass is free. If they are 60 years or older, they get a senior citizen discount. Otherwise, they pay the full price.
                ...
                gender = input("what type of gender: ")
                age = int(input("age of persons:"))
                
                if gender=="female":
                    print("the free ticket for ladies")
                else:
                    if  age<=5:
                        print(" the ticket for child is free")
                    elif age>=60:
                        print("senior discount ticket")
                    else:
                        print("the ticket is not free")
...
2. **Meal Time Checker**:
   - Create a program that checks the time of day (24-hour format) and prints whether it's time for breakfast, lunch, or dinner.
     ...
     - If none of these times, print "It's not meal time."
        ...
        **##We have to write for this code in two ways but ans is same ##** 

            **1st way**
                           time = int(input("time is the 24 hours: "))
                            
                            if time== 8:
                                print("this the breakfast time")
                            else:
                                if time== 13:
                                    print("this is lunch time")
                                elif time ==20:
                                    print("this is dinner time")
                                else:
                                    print("above time is not meals times")
